...
class CodeValidator:
    ...
    def __init__(self, security_config: SecurityConfig):
        ...
        self.file_operations = {"open", "file", "input", "raw_input", "execfile"}
    ...
    def validate(self, code: str) -> ValidationResult:
        ...
        is_valid = (
            syntax_valid and len(security_warnings) == 0 and security_score >= 0.7
        )
            ...
            for node in ast.walk(tree):
                if isinstance(node, ast.Import):
                    ...
                    if node.module:
                        ...
                        if module_name in self.dangerous_modules:
                            issues.append(
                                f"Dangerous module import from: {module_name}"
                            )
