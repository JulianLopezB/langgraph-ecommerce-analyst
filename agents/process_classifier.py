    ...
    def classify(
        ...
        with trace_agent_operation(
            ...
            try:
                ...
                logger.info(f"Classified as {result.process_type.value} with confidence {result.confidence:.2f}")
                return result
...
"""
    ...
    def _parse_classification_response(self, response_content: str, original_query: str) -> ProcessTypeResult:
        ...
        try:
            ...
            if process_type_str == "sql":
                ...
                logger.warning(f"Unknown process type: {process_type_str}, defaulting to SQL")
                process_type = ProcessType.SQL
            ...
            return ProcessTypeResult(
                ...
                requires_aggregation=bool(result_data.get("requires_aggregation", False)),
            ...
            if any(word in original_query.lower() for word in ["predict", "forecast", "model", "cluster", "correlation"]):
                return ProcessTypeResult(
                    process_type=ProcessType.PYTHON,
                    confidence=0.6,
            ...
            elif any(word in original_query.lower() for word in ["chart", "graph", "plot", "visualize", "show"]):
                return ProcessTypeResult(
                    process_type=ProcessType.VISUALIZATION,
                    confidence=0.6,
